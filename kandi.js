...
function animate() {
  if (!stop) {
    ...
    // draw the score
    ctx.fillText('Score: ' + score + 'm', canvas.width - 210, 30);
    ctx.fillText('Name: ' + 'Fatimah Al-khamees', canvas.width - 210, 45);
    ctx.fillText('Class: ' + 'DevOps online', canvas.width - 210, 60);
